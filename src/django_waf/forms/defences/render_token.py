...
from django_waf.forms.services.markers import issue_marker, marker_exists
from django_waf.forms.services.tokens import (
    TokenPayload,
    hash_user_agent,
    issue_token,
    verify_token,
...
class RenderTokenDefence:
    ...
    def render_fields(self, ctx: RenderContext) -> dict[str, SafeString]:
        ...
        ttl = ctx.config.get("token_ttl", conf.DJANGO_WAF_FORM_TOKEN_TTL)
