...
class TimeTrapDefence:
    ...
    def evaluate(self, ctx: EvaluateContext) -> Outcome:
        ...
        min_seconds = ctx.config.get("min_fill_seconds", conf.DJANGO_WAF_FORM_TIME_TRAP_MIN_SECONDS)
        max_seconds = ctx.config.get("max_fill_seconds", conf.DJANGO_WAF_FORM_TIME_TRAP_MAX_SECONDS)
