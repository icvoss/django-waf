"""
Management command: icv_waf_prune_logs
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser) -> None:
        parser.add_argument(
            ...
            type=int,
            default=None,
            help=("Override retention period in days (default: ICV_WAF_LOG_RETENTION_DAYS, typically 30)."),
        )
        parser.add_argument(
            "--dry-run",
            action="store_true",
    ...
    def handle(self, *args, **options) -> None:
        ...
        days: int = options["days"] if options["days"] is not None else conf.ICV_WAF_LOG_RETENTION_DAYS
