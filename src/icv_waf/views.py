...
logger = logging.getLogger("icv_waf.views")
...
class DashboardView(StaffRequiredMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs) -> dict:
        ...
        ctx["anomalies_url"] = reverse("icv_waf:dashboard-anomalies")
        return ctx
...
class DashboardStatsPanel(StaffRequiredMixin, TemplateView):
    ...
    template_name = "icv_waf/partials/stats_panel.html"
    ...
    def _fetch_stats(self) -> dict:
        ...
        try:
            ...
            logger.warning("icv-waf: could not fetch stats from Redis; falling back to DB")
...
class DashboardTopBlockedPanel(StaffRequiredMixin, TemplateView):
    ...
    template_name = "icv_waf/partials/top_blocked_panel.html"
...
class DashboardAnomalyPanel(StaffRequiredMixin, TemplateView):
    ...
    template_name = "icv_waf/partials/anomalies_panel.html"
...
class DashboardAnomalyConfirmView(SuperuserRequiredMixin, View):
    ...
    def post(self, request: HttpRequest, rule_id) -> HttpResponse:
        ...
        html = render_to_string(
            "icv_waf/partials/anomaly_row_confirmed.html",
            {"rule": rule},
            request=request,
        )
